...
const files=['desktop/main.cjs','desktop/preload.cjs','desktop/download.mjs','desktop/publish.mjs','shared/manifest.mjs','web/store.html','web/store.js','web/style.css','web/flow.js','web/index.html','web/landing.js','web/license.html','web/conduct.html','web/contributing.html'];
